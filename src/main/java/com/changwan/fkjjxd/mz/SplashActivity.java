        ...
        switch (msg.what) {
            case 1:
                if(time >= 0) {
                    ...
                    mSkipView.setText(String.format(SKIP_TEXT, Math.round(time)));
//                    mSkipView.setText(String.valueOf(time));
                    --time;
                } else {
                    finish();
                }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAdContainer = findViewById(R.id.container);
...
//        if (mSkipView != null && mSkipView.getVisibility() == View.GONE) {
...
//        }
    ...
    private void fetchSplashAd() {
        ...
        Log.i(TAG,"开屏num="+WLInitialization.instance().getSplashIni().get(0).getSdkPosition());
        mSplashAd = new SplashAd(SplashActivity.this,
                mAdContainer, mSkipView, WLInitialization.instance().getSplashIni().get(0).getSdkPosition(),SplashActivity.this);
...
//                mSplashAd = new SplashAd(SplashActivity.this,
//                        mAdContainer, mSkipView, WLInitialization.instance().getAdSDKSplashId(), SplashActivity.this);
//            }
//
//            @Override
//            public void onError(int code, String message) {
//                Toast.makeText(SplashActivity.this,
//                        "SDK初始化失败: " + message, Toast.LENGTH_LONG).show();
//                next();
//            }
//        });
        //next();
